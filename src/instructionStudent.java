...
public String rollNo;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(72, 15, -1, -1));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 75, 1360, 10));

        jTextArea2.setColumns(20);
        jTextArea2.setFont(new java.awt.Font("Monospaced", 1, 25)); // NOI18N
        jTextArea2.setRows(5);
        jTextArea2.setText("During the exam:\n\n1. The student may not use his or her textbook, course notes, or receive help from a \nproctor or any other outside source.\n\n2.Students must complete the 10-question multiple-choice exam within the 10-minute \ntime frame allotted for the exam.\n\n3.Students must not stop the session and then return to it. This is especially important in \nthe online environment where the system will \"time-out\" and not allow the student or you \nto reenter the exam.\n\nNumber of Question:10\n\nExam Duration: 10 min\n\nAll the Best!");
        jScrollPane2.setViewportView(jTextArea2);

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 91, 1350, 589));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(479, 698, -1, -1));
